...
class SaltWaterFish extends Fish{
    private String SaltWater;
    public SaltWaterFish(String name, int age, String color, String SaltWater){
        super(name, age, color, null);
    ...
    //getters and setters
    public String getSaltWater(){return SaltWater;}
    public void getSaltWater(String SaltWater){this.SaltWater = SaltWater;}
}
public class Main{
    public static void main(String[]args){
        ...
        //creating a waterfish

        System.out.print("\nEnter waterfish name: ");
        String waterfishName = scanner.nextLine();
        System.out.print("Enter waterfish age: ");
        int waterfishAge = scanner.nextInt();
        scanner.nextLine();
        System.out.print("Enter waterfish color: ");
        String waterfishColor= scanner.nextLine();
        System.out.print("Enter water type for waterfish: ");
        String waterfishType = scanner.nextLine();

        Animal waterfish = new SaltWaterFish(waterfishName, waterfishAge, waterfishColor, waterfishType);
        ...
        System.out.println();
        waterfish.displayInfo();
        waterfish.makeSound();
        waterfish.eat();
        ((SaltWaterFish)waterfish).swim();
        ...
        Animal[] animals = {cat, parrot, fish, waterfish};
        for( Animal animal : animals){
            animal.makeSound(); //each makes his own sound
        }
        //encapsulation - using getters 
        System.out.println("Names of all animals: ");
        for(Animal animal : animals){
